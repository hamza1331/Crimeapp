const login="LOGIN"
const logout='LOGOUT'
const insertCrime = 'INSERT_CRIME'
const showCrime = 'SHOW_CRIME'
const hideCrime = 'HIDE_CRIME'
const deleteCrime = 'DELETE_CRIME'
const insertComplain = 'INSERT_COMPLAIN'
const insertMissPerson = "INSERT_MISSING_PERSON"
